...
@endsection
@section('pageTitle', 'Image Category')
@section('content')
    <div class="row mb-5">
        ...
        <div class="col-lg-8 offset-lg-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Image Category Create</h3>
                </div>
                {{--     Form Start              --}}
                <form action="{{route('image.category.store')}}" class="form-horizontal" method="post">
                    @csrf
                        ...
                        @foreach($categories as $i => $c)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{route('image.category.delete', ['cid' => $c->id])}}" method="POST"
