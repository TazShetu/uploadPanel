...
@section('title', 'Image Vendor Edit')
@section('breadcrumb')
    <ul class="breadcrumb">
        <li>Images</li>
        <li><a href="{{route('image.vendor')}}">Vendor</a></li>
        <li class="active">Edit</li>
    </ul>
@endsection
@section('pageTitle', 'Image Vendor Edit')
@section('content')
    <div class="row mb-5">
        ...
        <div class="col-lg-8 offset-lg-2">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Image Vendor Edit</h3>
                </div>
                {{--     Form Start              --}}
                <form action="{{route('image.vendor.update', ['vid' => $vedit->id])}}" class="form-horizontal"
                      method="post">
                    @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($vedit->id != $v->id)
                                        ...
                                        <form action="{{route('image.vendor.delete', ['vid' => $v->id])}}"
                                              method="POST"
